...
public class vCalcMano extends JFrame implements  ActionListener, KeyListener
{
    ...
    JButton btnBorrarPoco=new JButton("<-");
    ...
    {   
        ...
        panelContenido2.setLayout(new GridLayout(5,4));   
        
        JPanel panelContenido3 = new JPanel();
        panelContenido3.setLayout(new GridLayout(4,1));
        
        JPanel panelContenido4 = new JPanel();
        panelContenido4.setLayout(new GridLayout(4,1));
        ...
        btnBorrarPoco.addActionListener(this);
        ...
        btnBorrarPoco.addKeyListener(this);
        btnFactorial.addKeyListener(this);
        ...
        btnBorrarPoco.addMouseListener(event);
        btnFactorial.addMouseListener(event);
        ...
        panelContenido2.add(btnBorrarPoco);
        panelContenido2.add(btnReset);
        panelContenido2.add(btnBorrar);
        ...
        panelContenido4.add(btnFactorial);
        
        panelContenido5.add(btnIgual);
                
        panelContenido.add(pantalla, BorderLayout.PAGE_START);
    ...
    {// Cuando comienza.. Visualiza a pantalla       
        ...
        if (ae.getSource() == btnSuma || ae.getSource() == btnResta || ae.getSource() == btnMult || ae.getSource() == btnDiv || ae.getSource() == btnExp || ae.getSource() == btnSqrt || ae.getSource() == btnDivX || ae.getSource() == btnFactorial) 
        {    
            ...
            else if(ae.getSource() == btnFactorial)
                event.btnFactorialActionPerformed(ae);
            oper = true;
        ...
        else if(ae.getSource() == btnBorrarPoco){
            event.btnBorrarPoco(ae);
        }        
